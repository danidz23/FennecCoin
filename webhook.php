...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $caption = "
            ...
            🟢  Upgrade your power and duration as you earn more FennecCoin.
            🟢 Complete daily tasks and invite friends to boost your earnings!

            How to use guide follow the link below: 
            https://ecosystem.FennecCoin.com/FennecCoin-whitepaper/about-products/FennecCoin-miner/how-to-start-mining
        ";

        // If there was a referrer, include their ID in the link
        $referralLink = $referrer_id ? "https://v2.FennecCoin.com/?ref=$referrer_id" : "https://v2.FennecCoin.com";
        ...
        if (file_exists($photoPath)) {
            ...
            $post_fields = [
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ['text' => 'Play FennecCoin Now', 'web_app' => ['url' => $referralLink]],
                            ['text' => 'Join Our Community', 'url' => 'https://t.me/FennecCoinAirdrop']]
                    ]
                ])
            ];
